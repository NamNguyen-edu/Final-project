...
{
    public partial class FormDSPhongCUS : Form
    {
        ...
        public FormDSPhongCUS()
        {
            InitializeComponent();
        }

        public FormDSPhongCUS(FormMain formMainCUS,TaiKhoan taiKhoan)
        {
            InitializeComponent();
            this.formMain = formMainCUS;
        ...
        private void FormDSPhongCUS_Load(object sender, EventArgs e)
        {
