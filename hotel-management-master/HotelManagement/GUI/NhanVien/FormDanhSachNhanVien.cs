...
namespace HotelManagement.GUI
{
    public partial class FormDanhSachNhanVien : Form
    {
        ...
        // Khởi tạo form danh sách nhân viên
        ...
        // Load danh sách nhân viên lên grid
        ...
        // Đổi icon con trỏ khi hover vào ô
